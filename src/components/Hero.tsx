...
const Hero: React.FC<HeroProps> = ({ sectionRef }) => {
  return (
    <section
      ...
      // Caminho da imagem: '/hero-background.jpg' significa que ela deve estar em 'public/hero-background.jpg'
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto animate-fade-in delay-200">
          Oferecemos serviços de limpeza e higienização de alta qualidade para estofados, camas, tapetes, sofás e interiores automotivos em <strong className="font-semibold text-primary-blue-light">Osasco/SP e regiões vizinhas</strong>. Experimente a diferença CleanPro para um ambiente mais saudável!
        </p>
