    ...
    >
      <div className="container mx-auto px-4">
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight animate-fade-in">
          Especialistas em Limpeza de Estofados e Automotiva em <span className="text-blue-400">Osasco/SP e Região</span>
        </h1>
        <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto animate-fade-in delay-200">
          Oferecemos serviços de limpeza e higienização de alta qualidade para estofados, camas, tapetes, sofás e interiores automotivos em <strong className="font-semibold text-blue-300">Osasco/SP e regiões vizinhas</strong>. Experimente a diferença CleanPro para um ambiente mais saudável!
        </p>
