      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              Professional cleaning services for a sparkling home. We provide top-notch 
              cleaning solutions with excellence and reliability you can trust.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>contact@cleanpro.com</li>
              <li>Rua Exemplo, 123<br />Centro, Osasco - SP</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {currentYear} CleanPro. All rights reserved. | Professional Cleaning Services
          </p>
        </div>
      </div>
    </footer>
